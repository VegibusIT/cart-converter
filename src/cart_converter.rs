...
use crate::convert::{self, ColumnMapping};
use crate::style::*;
...
impl Default for CartConverterPage {
    fn default() -> Self {
...
impl CartConverterPage {
    /// ページ描画。戻り値 true = トップに戻る
    ...
    fn show_mapping_panel(&mut self, ui: &mut egui::Ui) {
        egui::Frame::default()
            .fill(SURFACE)
            .corner_radius(egui::CornerRadius::same(8))
            .stroke(egui::Stroke::new(1.0, BORDER))
